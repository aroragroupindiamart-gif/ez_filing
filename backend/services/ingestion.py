...
COLUMN_ALIASES = {
    "invoice_number": [
        "invoice number", "invoice_no", "invoice #", "invoice no.",
        "bill number", "order id", "order-id",
    ],
    "invoice_date": [
        "invoice date", "order date", "shipment date", "invoice_date",
    ],
    "buyer_state": [
        "buyer state", "ship to state", "state", "customer state",
        "ship-to-state", "shipping state",
    ],
    "buyer_gstin": ["buyer gstin", "customer gstin", "gstin of buyer", "buyer_gstin"],
    "taxable_value": [
        "taxable value", "taxable_value", "principal amount",
        "invoice value (without tax)", "amount",
    ],
    "igst": ["igst", "igst amount", "igst rate * taxable"],
    "cgst": ["cgst", "cgst amount"],
    "sgst": ["sgst", "sgst amount", "utgst"],
    "cess": ["cess", "cess amount"],
    "total_value": ["invoice amount", "total value", "invoice total", "total"],
